export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 LibreCode",
  ...
  "desktop.menu.help.documentation": "LibreCode 文件",
  ...
  "desktop.cli.error.sidecarMissing": "LibreCode CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
