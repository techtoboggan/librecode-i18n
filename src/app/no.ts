...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i LibreCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i librecode.json",
  ...
  "dialog.server.description": "Bytt hvilken LibreCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av LibreCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til LibreCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (librecode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at LibreCode ikke støtter MCP-autentisering ennå.',
  ...
  "settings.desktop.wsl.description": "Kjør LibreCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for LibreCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan LibreCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om LibreCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan LibreCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når LibreCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av LibreCode.",
