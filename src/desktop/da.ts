export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af LibreCode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'librecode'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "LibreCode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
