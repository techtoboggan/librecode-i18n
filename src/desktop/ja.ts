export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの LibreCode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "LibreCode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'librecode' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "LibreCode ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "LibreCode CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
