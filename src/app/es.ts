export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en LibreCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en librecode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de LibreCode se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de LibreCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de LibreCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (librecode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, LibreCode no soporta autenticación MCP todavía.',
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor LibreCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para LibreCode",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve LibreCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si LibreCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de LibreCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia LibreCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de LibreCode.",
