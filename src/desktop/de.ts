export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von LibreCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'librecode' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "LibreCode-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das LibreCode CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
