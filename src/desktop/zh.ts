export const dict = {
  ...
  "desktop.updater.none.message": "你已经在使用最新版本的 LibreCode",
  ...
  "desktop.menu.help.documentation": "LibreCode 文档",
  ...
  "desktop.cli.error.sidecarMissing": "LibreCode CLI 二进制文件缺失。请尝试重新安装桌面应用程序。",
