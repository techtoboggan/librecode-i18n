export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do LibreCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada em {{path}}\n\nReinicie seu terminal para usar o comando 'librecode'.",
  ...
  "desktop.menu.help.documentation": "Documentação do LibreCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do LibreCode está ausente. Tente reinstalar o aplicativo de desktop.",
