export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju LibreCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} LibreCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'librecode'.",
  ...
  "desktop.menu.help.documentation": "LibreCode Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka LibreCode CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
