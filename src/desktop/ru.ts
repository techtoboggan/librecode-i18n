export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию LibreCode",
  ...
  "desktop.updater.downloaded.prompt": "Версия LibreCode {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'librecode'.",
  ...
  "desktop.menu.help.documentation": "Документация LibreCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл LibreCode CLI. Попробуйте переустановить настольное приложение.",
