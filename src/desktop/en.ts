export const dict = {
  ...
  "desktop.menu.help.documentation": "LibreCode Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of LibreCode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "LibreCode CLI binary is missing. Try reinstalling the desktop app.",
