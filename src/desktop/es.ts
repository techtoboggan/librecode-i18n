export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de LibreCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'librecode'.",
  ...
  "desktop.menu.help.documentation": "Documentación de LibreCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de LibreCode. Intenta reinstalar la aplicación de escritorio.",
