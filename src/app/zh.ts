...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 LibreCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 LibreCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 LibreCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 librecode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 LibreCode 服务器。",
  ...
  "toast.update.description": "LibreCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 LibreCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (librecode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: LibreCode 暂不支持 MCP 认证。',
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 LibreCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 LibreCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 LibreCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 LibreCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 LibreCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 LibreCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 LibreCode。",
