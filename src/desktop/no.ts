export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av LibreCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'librecode'-kommandoen.",
  ...
  "desktop.menu.help.documentation": "LibreCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "LibreCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
