export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'LibreCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'librecode'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'LibreCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI LibreCode est manquant. Essayez de réinstaller l'application de bureau.",
