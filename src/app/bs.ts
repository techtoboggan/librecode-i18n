export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u LibreCode-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u LibreCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u LibreCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u librecode.json",
  ...
  "dialog.server.description": "Promijeni na koji se LibreCode server ova aplikacija povezuje.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku LibreCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (librecode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: LibreCode još ne podržava MCP autentifikaciju.',
  ...
  "settings.desktop.wsl.description": "Pokreni LibreCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u LibreCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako LibreCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li LibreCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu LibreCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se LibreCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju LibreCode-a.",
