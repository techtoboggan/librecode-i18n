...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve LibreCode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak LibreCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler librecode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi LibreCode sunucusuna bağlanacağını değiştirin.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı LibreCode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (librecode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: LibreCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "app.name.desktop": "LibreCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "LibreCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "LibreCode'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "LibreCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "LibreCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "LibreCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "LibreCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "LibreCode'un en son sürümünü kullanıyorsunuz.",
