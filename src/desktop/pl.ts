export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} LibreCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja LibreCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego LibreCode CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
