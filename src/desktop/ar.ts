export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من LibreCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من LibreCode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق LibreCode",
  ...
  "desktop.cli.error.sidecarMissing": "ملف LibreCode CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
