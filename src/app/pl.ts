export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w LibreCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w librecode.json",
  ...
  "dialog.server.description": "Przełącz serwer LibreCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja LibreCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu LibreCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (librecode.json) nazwy dostawców/modeli",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla LibreCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd LibreCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy LibreCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw LibreCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania LibreCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji LibreCode.",
